...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/24 05:52:29 by gizawahr          #+#    #+#             */
/*   Updated: 2021/12/24 05:52:29 by gizawahr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_res(t_params *par, char *line)
{
	...
	if (par->res_w != 0 && par->res_h != 0)
		ft_quit("la resolution est deja enregistrée\n", par);
	...
	if (par->res_h < 1 || par->res_w < 1)
		ft_quit("Taille de fenetre trop petite\n", par);
}
